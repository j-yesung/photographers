...
<%         } %>
	...
	<div id="main" align="center">
		...
		<div>
		<form action="adRejectPro.jsp" method="post">
			<table width="1000">
				<tr>
					<td colspan="3">
				...
				<tr>
					<td rowspan="2">[내용] <%=gallery.getG_content()%></td>
				</tr>
				
				<tr>
					<td rowspan="2" align="center">
						<input type="button" value="승인" onclick="window.location='/team/admin/adSellRequestPro.jsp?g_bno=<%=gallery.getG_bno()%>&pageNum=<%=pageNum%>'" />
					</td>
					<td rowspan="2" align="center">
				...
				<tr>
					<td>
						<textarea cols="110" name="g_comment" placeholder="반려코멘트를 입력하세요.">
						</textarea>
					</td>
				</tr>
			</table>
	...
	<div id="mainSub" align="center">
		<button onclick="window.location='adSellRequest.jsp?pageNum=<%=pageNum%>'">전체글로 돌아가기</button>
	</div> <%-- mainSub의 끝 --%>
